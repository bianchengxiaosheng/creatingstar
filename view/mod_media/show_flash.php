			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom <?php if($act=="mod_product"){echo "active";} ?>"><a href="index.php?_m=mod_product&_a=prdlist&cap_id=34">Services<i><img src="images/nav-but3.png" alt=""/></i></a></li>
